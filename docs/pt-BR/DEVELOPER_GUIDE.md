...
| **UI Framework** | Bootstrap | 5.x (GLPI 10) |
| **Icons** | Tabler Icons | (GLPI 10) |
| **Backend** | PHP | 8.1+ |
...
- **GLPI 10.0+** instalado e funcionando
- **PHP 7.4+** com extensões: mysqli, json, mbstring, session
...
Todos os modais seguem o padrão Bootstrap 4:
...
- [Bootstrap 4 Documentation](https://getbootstrap.com/docs/5.0/)
